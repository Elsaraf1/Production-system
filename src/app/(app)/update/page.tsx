      ...
      <div className="rounded-lg border bg-white overflow-x-auto lg:overflow-visible">
        <table className="w-full text-sm lg:border-separate lg:border-spacing-0 lg:[&_th]:border-b lg:[&_td]:border-b">
          <thead className="bg-gray-50 border-b">
            <tr>
              <th className="lg:sticky lg:z-10 lg:top-[68px] bg-gray-50 text-left px-4 py-3 font-medium">PPO</th>
              ...
              <th className="lg:sticky lg:z-10 lg:top-[68px] bg-gray-50 text-left px-4 py-3 font-medium">RSD</th>
              {stageConfig ? (
                <th className="lg:sticky lg:z-10 lg:top-[68px] bg-gray-50 text-left px-4 py-3 font-medium">{stageConfig.label}</th>
              ) : (
                ["Drawing","Carpentry","Painting","Upholstery","Packing"].map(s => (
                  <th key={s} className="lg:sticky lg:z-10 lg:top-[68px] bg-gray-50 text-left px-4 py-3 font-medium">{s}</th>
                ))
              )}
            </tr>
          </thead>
